...
urlpatterns = [
    ...
    path("rounds/team/", TeamManagementSelectionView.as_view(), name="team_management_selection"),
    path("rounds/team/<int:round_id>/", TeamMembersView.as_view(), name="team_members"),
