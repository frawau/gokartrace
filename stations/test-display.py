...
class FramebufferDisplay:
    def __init__(self):
        ...
        # Load font
        try:
            self.large_font = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf', 200)
            self.medium_font = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf', 100)
    ...
    def get_screen_info(self):
        ...
        try:
            with open('/sys/class/graphics/fb0/virtual_size', 'r') as f:
                ...
                self.width = width
                self.height = height
                print(f"Detected framebuffer size from sysfs: {self.width}x{self.height}")
        except Exception as e:
        ...
        print(f"Screen setup: {self.width}x{self.height}, {self.bpp}bpp, {self.screen_size} bytes")
...
def main():
    ...
    try:
        ...
        try:
            display.display_text("HELLO", (255, 165, 0), (0, 0, 0))  # Orange background, black text
            print("HELLO displayed, waiting 3 seconds...")
            time.sleep(3)
            
            print("About to display 'RPi ZERO W'...")
            display.display_text("RPi ZERO W", (0, 255, 0), (255, 255, 255))  # Green background, white text
            print("RPi ZERO W displayed, waiting 3 seconds...")
            time.sleep(3)
            
            print("About to display '123'...")
            display.display_text("123", (255, 0, 0), (255, 255, 0))  # Red background, yellow text
